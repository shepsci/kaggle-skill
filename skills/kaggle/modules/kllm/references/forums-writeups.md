...
|---|---|
| Browse global Kaggle forums | `kaggle forums` or `cli_forums.py forums` |
| Search global discussion topics | `kaggle forums topics list` or `cli_forums.py forum-topics` |
| Read a topic and comments | `kaggle forums topics show` or `cli_forums.py forum-topic` |
| Browse competition discussions | `kaggle competitions topics list` or `cli_forums.py resource-topics competitions` |
| Browse dataset/kernel/model/benchmark topics | `kaggle <resource> topics list` or `cli_forums.py resource-topics <resource>` |
...
python3 skills/kaggle/modules/kllm/scripts/cli_forums.py forums --format json
```
...
python3 skills/kaggle/modules/kllm/scripts/cli_forums.py forum-topic \
...
python3 skills/kaggle/modules/kllm/scripts/cli_forums.py resource-topic \
