...
TOOL_PROBES: list[tuple[str, dict, tuple[str, ...]]] = [
    ...
    ("list_competition_pages", {"request": {"competitionName": "titanic"}}, ("ok",)),
    ("list_competition_pages", {"request": {"competitionName": "playground-series-s6e2"}}, ("ok",)),
    ("list_competition_pages", {"request": {"competitionName": "kaggle-measuring-agi"}}, ("ok",)),
