#!/usr/bin/env python3
"""Test suite for the badges workflow module.
...
Usage:
    python tests/test_badges.py              # run all tests
    python tests/test_badges.py --unit        # unit tests only
    python tests/test_badges.py --phase 1     # run phase 1 integration test
    python tests/test_badges.py --phase all   # all phases live
"""
...
SCRIPTS_DIR = REPO_ROOT / "skills" / "kaggle" / "modules" / "badges" / "scripts"
...
def test_utils():
    ...
    try:
        ...
        if n1.startswith("kaggle-badges-test-"):
...
def test_skill_md():
    ...
    try:
        skill_path = REPO_ROOT / "skills" / "kaggle" / "SKILL.md"
        ...
        # Content sections
        for section in ["Module Map", "Core Workflows", "Safety"]:
...
def test_project_structure():
    ...
    expected_files = [
        ...
        "skills/kaggle/modules/badges/scripts/badge_registry.py",
        "skills/kaggle/modules/badges/scripts/badge_tracker.py",
        "skills/kaggle/modules/badges/scripts/utils.py",
        "skills/kaggle/modules/badges/scripts/phase_1_instant_api.py",
        "skills/kaggle/modules/badges/scripts/phase_2_competition.py",
        "skills/kaggle/modules/badges/scripts/phase_3_pipeline.py",
        "skills/kaggle/modules/badges/scripts/phase_4_browser.py",
        "skills/kaggle/modules/badges/scripts/phase_5_streaks.py",
        "skills/kaggle/modules/badges/references/badge-catalog.md",
...
def generate_report():
    ...
    report_path = REPO_ROOT / "tests" / f"test-badges-report-{datetime.now().strftime('%Y-%m-%d')}.md"
