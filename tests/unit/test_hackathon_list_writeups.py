"""Unit tests for skills/kaggle/modules/kllm/hackathon/scripts/list_writeups.py."""
...
SCRIPT = REPO_ROOT / "skills" / "kaggle" / "modules" / "kllm" / "hackathon" / "scripts" / "list_writeups.py"
