"""Unit tests for skills/kaggle/modules/kllm/scripts/cli_forums.py."""
...
SCRIPT = REPO_ROOT / "skills" / "kaggle" / "modules" / "kllm" / "scripts" / "cli_forums.py"
...
def test_help_exits_zero():
    mod = _load_module()
    with patch.object(sys, "argv", ["cli_forums.py", "--help"]):
        try:
            mod.parse_args(["--help"])
