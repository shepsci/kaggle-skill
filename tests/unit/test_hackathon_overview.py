"""Unit tests for skills/kaggle/modules/kllm/hackathon/scripts/hackathon_overview.py."""
...
SCRIPT = REPO_ROOT / "skills" / "kaggle" / "modules" / "kllm" / "hackathon" / "scripts" / "hackathon_overview.py"
