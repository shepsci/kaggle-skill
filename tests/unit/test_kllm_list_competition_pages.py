"""Unit tests for skills/kaggle/modules/kllm/scripts/list_competition_pages.py."""
...
SCRIPT = REPO_ROOT / "skills" / "kaggle" / "modules" / "kllm" / "scripts" / "list_competition_pages.py"
